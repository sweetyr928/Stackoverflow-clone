...
|<p align="left">- Question CRUD기능 <br/> - AWS(EC2,RDS) <br/> - 배포환경 구축 </p>|<p align="left">- PL 수행 <br/>- APP 설계 및<br/>공통 모듈 구현 <br/> s3 배포  </p>|<p align="left">- Answer CRUD 기능 <br/>- AWS(EC2,RDS)<br/> - 배포환경 구축 </p>|<p align="left"> <br/>- Member CRUD 기능 <br/> - JWT 적용 <br/>- AWS(EC2,RDS) <br/> - 배포환경 구축 </p>|<p align="left">- 질문 등록 기능 구현<br/>- Tags 조회 기능 구현<br/>- 마이페이지 기능 구현<br/>- 공통 컴포넌트 구현</p>|<p align="left">- 질문 전체 조회 기능 구현 <br/> - 질문 상세 조회 기능 구현 <br/> - 답변 등록 기능 구현 <br/> - 투표 기능 구현 </p>|
